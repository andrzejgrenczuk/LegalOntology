 ...
 * Source Class: DefaultZakres_przedmiotowy <br>
 * @version generated on Sat May 07 16:00:15 CEST 2022 by andrz
 */
public class DefaultZakres_przedmiotowy extends WrappedIndividualImpl implements Zakres_przedmiotowy {

    public DefaultZakres_przedmiotowy(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends Integer> getWartośćPrzedmiotuSporu() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_WARTOŚĆPRZEDMIOTUSPORU, Integer.class);
    }

    public boolean hasWartośćPrzedmiotuSporu() {
		return !getWartośćPrzedmiotuSporu().isEmpty();
    }

    public void addWartośćPrzedmiotuSporu(Integer newWartośćPrzedmiotuSporu) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_WARTOŚĆPRZEDMIOTUSPORU, newWartośćPrzedmiotuSporu);
    }

    public void removeWartośćPrzedmiotuSporu(Integer oldWartośćPrzedmiotuSporu) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_WARTOŚĆPRZEDMIOTUSPORU, oldWartośćPrzedmiotuSporu);
    }
