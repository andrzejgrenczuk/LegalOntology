 ...
 * Source Class: Zakres_przedmiotowy <br>
 * @version generated on Sat May 07 16:00:15 CEST 2022 by andrz
 */

public interface Zakres_przedmiotowy extends Zakres_działalności_sądu {
    ...
    /* ***************************************************
     * Property http://www.semanticweb.org/andrz/ontologies/2021/9/PostepowanieCywilne#WartośćPrzedmiotuSporu
     */
     
    /**
     * Gets all property values for the WartośćPrzedmiotuSporu property.<p>
     * 
     * @returns a collection of values for the WartośćPrzedmiotuSporu property.
     */
    Collection<? extends Integer> getWartośćPrzedmiotuSporu();

    /**
     * Checks if the class has a WartośćPrzedmiotuSporu property value.<p>
     * 
     * @return true if there is a WartośćPrzedmiotuSporu property value.
     */
    boolean hasWartośćPrzedmiotuSporu();

    /**
     * Adds a WartośćPrzedmiotuSporu property value.<p>
     * 
     * @param newWartośćPrzedmiotuSporu the WartośćPrzedmiotuSporu property value to be added
     */
    void addWartośćPrzedmiotuSporu(Integer newWartośćPrzedmiotuSporu);

    /**
     * Removes a WartośćPrzedmiotuSporu property value.<p>
     * 
     * @param oldWartośćPrzedmiotuSporu the WartośćPrzedmiotuSporu property value to be removed.
     */
    void removeWartośćPrzedmiotuSporu(Integer oldWartośćPrzedmiotuSporu);
